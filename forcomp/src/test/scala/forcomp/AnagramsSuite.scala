...
class AnagramsSuite extends FunSuite {
  ...
  // from example
  test("wordOccurrences: You olive") {
    assert(wordOccurrences("You olive") === List(('e', 1), ('i', 1), ('l', 1), ('o', 2), ('u', 1), ('v', 1), ('y', 1)))
  }
  ...
  test("subsets of an occurrence") {
    assert(combinations(List(('a', 2), ('b', 2))).toSet === List(
      List(),
      List(('a', 1)),
      List(('a', 2)),
      List(('b', 1)),
