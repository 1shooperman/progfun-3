...
object pairs {
  ...
  (1 until n) map (i =>
    (1 until i) map (j => (i, j)))                //> res0: scala.collection.immutable.IndexedSeq[scala.collection.immutable.Index
                                                  ...
                                                  //| , (6,2), (6,3), (6,4), (6,5)))
  val test = (1 until n) flatMap (i =>
    (1 until i) map (j => (i, j)))                //> test  : scala.collection.immutable.IndexedSeq[(Int, Int)] = Vector((2,1), (3
  ...
  test filter (pair => isPrime(pair._1 + pair._2))//> res1: scala.collection.immutable.IndexedSeq[(Int, Int)] = Vector((2,1), (3,2
                                                  //| ), (4,1), (4,3), (5,2), (6,1), (6,5))

  for {
    i <- 1 until n
    j <- 1 until i
  } yield (i, j)                                  //> res2: scala.collection.immutable.IndexedSeq[(Int, Int)] = Vector((2,1), (3,1
